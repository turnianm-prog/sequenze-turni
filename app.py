      ...
      with st.spinner(
        ...
        try:
          ...
          prompt = (
              ...
              " esatto formato: COGNOME;CODICE;TURNO;ASSEGNATO_A."
          )
          ...
          if not response or not response.text:
            st.error(
                "L'IA non ha restituito alcun testo. Riprova con un'altra"
                " foto."
            )
          else:
            ...
            if not data_giornaliera:
              st.warning(
                  "Testo grezzo restituito dall'IA (verifica se la foto è"
                  f" leggibile): \n\n {response.text}"
              )
            else:
          ...
          st.error(f"Errore tecnico riscontrato: {e}")
